...
class TomorrowLectureNotification extends Notification
{
    use Queueable;
    ...
    {
        $isTeacher = get_class($notifiable) === get_class($this->appointment->teacher);

        return [
            'message' => $this->message,
            'appointment_id' => $this->appointment->id,
            'type' => 'tomorrow_lecture',
            ...
            'for_role' => $isTeacher ? 'teacher' : 'student',
        ];
    }
}

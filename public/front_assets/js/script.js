(function ($) {
    ...
    // Start Equal Teacher Cards

    var cards = document.querySelectorAll(".card-teacher");
    ...
    // End Equal why us Cards

    // Start Equal our courses Cards
    ...
    $(document).ready(function () {
        $("#contact-form").validate({
            ...
            //   },
            //   'checkboxes': {
            //     required: "Please check At Least One Option to continue"
            //   },
            //   'select': {
  ...
  *
  /* *********************************** */
    ...
    // ====================================================
    // ***** Start Birthday Field Options - Join Us Form
    ...
    $(document).ready(function () {
        $("#datepicker").datepicker({
            ...
            showAnim: "drop",
            // showAnim: 'slideDown',
            // You can also use other themes provided by jQuery UI
    ...
    // ***** End Birthday Field Options - Join Us Form
    ...
    // Register as Student or Teacher Option

    document.addEventListener("DOMContentLoaded", function () {
        const studentFields = document.querySelectorAll("#student-fields");
        const teacherFields = document.querySelectorAll("#instructor_fields");
        const registerTypeRadios = document.querySelectorAll(
            "input[name='register_type']"
        );
        const registerTypeInput = document.getElementById("register_type");
        if (registerTypeRadios.length <= 0) return;
        const showFields = () => {
            if (registerTypeRadios[0].checked) {
            ...
            } else if (registerTypeRadios[1].checked) {
                // Teacher radio button is checked
        ...
        showFields(); // Call on page load to show default fields
    ...
    /** === === === === */
    // display field type text if user select yes in other licience form group
    $(document).ready(function () {
        $('input[name="other_license"]').change(function () {
            var selectedValue = $(this).val();
            if (selectedValue === "yotherlicense") {
                $("#text_field_container").addClass("animated zoomIn").show();
            } else {
    ...
    // ================
    // display field type text if user check other option in available working hours form group
    $(document).ready(function () {
        // When the "Other" checkbox is clicked
        $('#other_hours[value="other"]').click(function () {
            if ($(this).is(":checked")) {
                // Show the "Other" field with animation
                $("#other_field").slideDown();
            } else {
                // Hide the "Other" field with animation
                $("#other_field").slideUp();
            }
        });
    });
  ...
  *
  /* *********************************** */
    ...
    // open review box in course details
    ...
    // Payment Methods Selected Radio button
    $(document).ready(function () {
    ...
    // === End Upload Audio File Field === //

    /** === === === === === === */

    // Add Country Code Automatically to Phone Field - Join Us
    const phoneInput = document.querySelector("#phone");

    function intlTelInput() {
        window.intlTelInput(phoneInput, {
            // These options will customize the input field.
            initialCountry: "Eg",
            ...
            // These options will validate the phone number.
            allowInvalidNumbers: false,
            defaultCountry: "Eg",
            utilsScript:
                "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/utils.js",
            // This option will set the initial country based on the user's IP address.
            geoIpLookup: function () {
                // Get the user's location based on their IP address.
                const ip = window.location.hostname;
                const geolocation = ipinfo.get(ip);

                // Set the country code for the input field.
                const countryCode = geolocation.countryCode;
                phoneInput.setCountry(countryCode);
            },
            // This option will add all countries to the dropdown list.
            allCountries: true,
        });
    }

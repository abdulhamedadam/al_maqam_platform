                            ...
                            <div class="tab-pane fade active show" id="notifications" role="tabpanel"
                                ...
                                <div class="container notifications-container">
                                    ...
                                    <div class="filter-tabs">
                                        ...
                                        <button class="filter-tab" data-filter="lecture_reminder">{{ trans('notifications.lecture_reminder') }}</button>
                                        <button class="filter-tab" data-filter="lecture_started">{{ trans('notifications.lecture_started') }}</button>
                                        <button class="filter-tab" data-filter="lecture_missed">{{ trans('notifications.lecture_missed') }}</button>
                                        <button class="filter-tab" data-filter="auto_ended_lecture">{{ trans('notifications.auto_ended') }}</button>
                                        <button class="filter-tab" data-filter="tomorrow_lecture">{{ trans('notifications.tomorrow_lecture') }}</button>
                                        <button class="filter-tab" data-filter="lecture_completed">{{ trans('notifications.lecture_completed') }}</button>
                                        <button class="filter-tab" data-filter="cancelled">{{ trans('notifications.cancelled') }}</button>
                                    </div>
                                    ...
                                    <div class="notifications-list">
                                        @forelse($notifications as $notification)
                                            @php
                                                ...
                                                $filterType = match($notificationType) {
                                                    ...
                                                    'LectureStartedNotification' => 'lecture_started',
                                                    ...
                                                    'LectureCompletedNotification' => 'lecture_completed',
                                                ...
                                                $typeLabel = trans("notifications.$filterType");
                                            @endphp
                                                    ...
                                                    <div class="notification-details mt-2 p-2 bg-light rounded">
                                                        <small class="text-muted">
                                                            @switch($notificationType)
                                                                    ...
                                                                    <div class="d-flex flex-column gap-2">
                                                                        ...
                                                                        @if(isset($data['cancelled_by']))
                                                                            <div>
                                                                                ...
                                                                                <strong>{{ trans('notifications.cancelled_by') }}:</strong> {{ $data['cancelled_by'] ?? trans('notifications.student') }}
                                                                            </div>
                                                                        @endif
                                                                        @if(isset($data['reason']))
                                                                            <div>
                                                                                <i class="fa fa-comment-alt text-danger"></i>
                                                                                <strong>{{ trans('notifications.reason') }}:</strong> {{ $data['reason'] }}
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    @break
                                                                    ...
                                                                    <div class="d-flex flex-column gap-2">
                                                                        @if(isset($data['teacher_name']))
                                                                            <div>
                                                                                ...
                                                                                <strong>{{ trans('notifications.teacher') }}:</strong> {{ $data['teacher_name'] }}
                                                                            </div>
                                                                        @endif
                                                                        @if(isset($data['course_name']))
                                                                            <div>
                                                                        ...
                                                                        @if(isset($data['overtime_minutes']))
                                                                            <div class="text-warning">
                                                                                ...
                                                                                {{ $data['overtime_minutes'] }} {{ trans('notifications.minutes') }}
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    @break
                                                                        ...
                                                                        @if(isset($data['zoom_link']))
                                                                            <div>
                                                                                ...
                                                                                <a href="{{ $data['zoom_link'] }}" target="_blank" class="btn btn-sm btn-primary">
                                                                                    <i class="fa fa-sign-in-alt"></i> {{ trans('notifications.join') }}
                                                                                </a>
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex flex-column gap-2">
                                                                        ...
                                                                        @if($notificationType === 'LectureReminderNotification' && isset($data['reminder_minutes']))
                                                                            <div class="text-warning">
                                                                                ...
                                                                                <strong>{{ trans('notifications.reminder') }}:</strong>
                                                                ...
                                                                @case('LectureCompletedNotification')
                                                                    <div class="d-flex flex-column gap-2">
                                                                        @if(isset($data['teacher_name']))
                                                                            <div>
                                                                                <i class="fa fa-user text-success"></i>
                                                                        ...
                                                                        @if(isset($data['evaluation']))
                                                                            <div>
                                                                                ...
                                                                                <strong>{{ trans('notifications.rating') }}:</strong>
                                                                                {{ $data['evaluation']['rating'] ?? 'N/A' }} / 5
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    @break
                                                                ...
                                                                @default
                                                                    @if(isset($data['appointment']))
                                                                        <div class="d-flex flex-column gap-2">
                                                                            @if(isset($data['appointment']['teacher_name']))
                                                                                <div>
                                                                                    <i class="fa fa-user"></i>
                                                                                    <strong>{{ trans('notifications.teacher') }}:</strong> {{ $data['appointment']['teacher_name'] }}
                                                                                </div>
                                                                            @endif
                                        ...
                                        @empty
                                            <div class="empty-state">
                                                ...
                                                <h4>{{ trans('notifications.title') }}</h4>
                                    ...
                                    <div class="empty-state filtered-empty" style="display: none;">
                                        <i class="fa fa-bell-slash"></i>
                                        <h4>{{ trans('notifications.filtered_title') }}</h4>
                                        <p>{{ trans('notifications.filtered_description') }}</p>
                                    </div>
                                    <!-- Pagination -->
                                                                    ...
                                                                    <div class="d-flex flex-column gap-2">
                                                                        ...
                                                                        @if(isset($data['zoom_link']))
                                                                            <div>
                                                                                <i class="fa fa-video text-success"></i>
                                                                                <a href="{{ $data['zoom_link'] }}" target="_blank" class="btn btn-sm btn-primary">
                                                                                    <i class="fa fa-sign-in-alt"></i> {{ trans('notifications.join_lecture') }}
                                                                                </a>
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                ...
                                                                @case('LectureCompletedNotification')
                                                                    <div class="d-flex flex-column gap-2">
                                                                        ...
                                                                        @if(isset($data['evaluation']))
                                                                            <div>
                                                                                <i class="fa fa-star text-warning"></i>
                                                                                <strong>{{ trans('notifications.evaluation') }}:</strong>
                                                                                {{ $data['evaluation']['rating'] ?? 'N/A' }} / 5
                                                                            </div>
                                                                        @endif
                                                                    </div>
        ...
        function filterNotifications(filter) {
            ...
            switch(filter) {
                ...
                case 'lecture_started':
                    $('.notification-item[data-type="lecture_started"]').show();
                    hasVisibleItems = $('.notification-item[data-type="lecture_started"]').length > 0;
                    break;
                case 'lecture_missed':
                ...
                case 'lecture_completed':
                    $('.notification-item[data-type="lecture_completed"]').show();
                    hasVisibleItems = $('.notification-item[data-type="lecture_completed"]').length > 0;
                    break;
                case 'cancelled':

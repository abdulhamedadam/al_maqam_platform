                                    ...
                                    <ul class="nav mb-30" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="enrolled-tab" data-bs-toggle="tab"
                                                ...
                                                {{ trans('profile.enrolled_courses') }} ({{ $assignedCourses->count() }})
                                            </button>
                                        </li>
                                        {{-- <li class="nav-item" role="presentation">
                                                        ...
                                                        <div class="col-xl-4 col-lg-6 col-md-6">
                                                            <div class="course-wrapper-2 mb-30">
                                                                <div class="student-course-img">
                                                                    <img src="{{ $assigned->course->image ? asset('images/' . $assigned->course->image) : asset('front_assets/images/id/logo.jpg') }}"
                                                                        alt="course-img" />
                                                                </div>
                                                                    ...
                                                                    <div class="course-info-wrapper">
                                                                        <div class="cart-info-body">
                                                                            <span class="category-color category-color-3"><a
                                                                                    href="#">{{ $assigned->course?->section?->name }}</a></span>
                                                                            <a
                                                                                href="{{ route('user.get_course_details', [$assigned->course_id, $assigned->money_id]) }}">
                                                                                <h3>{{ $assigned->course?->name }}</h3>
                                                                            </a>
                                                                            <div class="cart-lavel">
                                                                                <h5>
                                                                                    {{ trans('profile.level') }} :
                                                                                    <span>{!! $assigned->course?->seo_head_keyword !!}</span>
                                                                                </h5>
                                                                                <p>
                                                                                    {!! $assigned->course?->seo_head_description !!}
                                                                                </p>
                                                                            </div>
                                                                            <div class="info-cart-text">
                                                                                <ul>
                                                                                    <li>
                                                                                        ...
                                                                                        {{ $assigned->money?->num_of_lectures }}
                                                                                        {{ trans('profile.lessons') }}
                                                                                    </li>
                                                                                    <li>
                                                                                        @include('site.includes.check_icon')
                                                                                        {{ $assigned->money?->num_of_minuts }}
                                                                                        {{ trans('profile.minutes_per_lesson') }}
                                                                                    </li>
                                                                                    <li>
                                                                                        @include('site.includes.check_icon')
                                                                                        @if ($assigned->course?->min_age && $assigned->course?->max_age)
                                                                                            @if ($assigned->course->min_age < 18 && $assigned->course->max_age >= 18)
                                                                                                {{ trans('site.kids_and_adults') }}
                                                                                            @elseif($assigned->course->max_age < 18)
                                                                                                {{ trans('site.kids') }}
                                                                                            @else
                                                                                                {{ trans('site.adults') }}
                                                                                            @endif
                                                                                    ...
                                                                                    <li>
                                                                                        @include('site.includes.check_icon')
                                                                                        @if ($assigned->money?->for_group)
                                                                                            {{ trans('site.group_class') }}
                                                                                            (Max
                                                                                            {{ $assigned->money?->max_in_group }}
                                                                                            {{ trans('site.students') }})
                                                                                        @else
                                                                            ...
                                                                            <div class="course-action">
                                                                                <a href="{{ route('user.get_course_details', [$assigned->course_id, $assigned->money_id]) }}"
                                                                ...
                                                                <div class="student-course-footer">
                                                                    <div class="student-course-linkter">
                                                                        <div class="course-lessons">
                                                                            ...
                                                                            <span class="ml-8">{{ $assigned->money?->num_of_lectures }} {{ trans('profile.lessons') }}</span>
                                                                        </div>
                                                                        <div class="portfolio-price">
                                                                            <span>{{ $assigned->money?->total_price }} {{ trans('site.LE') }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="student-course-text" style="flex-grow: 1 !important; min-width: 250px !important;">
                                                                        <h3>
                                                                            <a href="{{ route('user.get_course_details', [$assigned->course_id, $assigned->money_id]) }}">{{ $assigned->course?->name }}:
                                                                                {{ $assigned->course?->seo_head_keyword }}</a>
                                                                        </h3>
                                                                    </div>
                                                                    ...
                                                                    <div class="portfolio-user mt-2">
                                                                        <div class="user-icon">
                                                                            <a href="#"><i
                                                                                    class="fas fa-user"></i>{{ $assigned->student?->name }}</a>
                                                                        </div>
                                                                    </div>

                                                                    <div class="portfolio-time mt-2">
                                                                        <div class="time-icon">
                                                                            <a href="#"><i class="fas fa-clock"></i> {{ trans('profile.'. $assigned->day) }} {{ $assigned->start_time }} - {{ $assigned->end_time }}</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>

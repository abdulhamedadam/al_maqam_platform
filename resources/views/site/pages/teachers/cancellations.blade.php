                                            ...
                                            <div class="cancellation-item">
                                                ...
                                                <div class="cancellation-body">
                                                    <div class="cancellation-details">
                                                        ...
                                                        @if($cancellation->appointment->student)
                                                            <div class="detail-item">
                                                                <i class="fa fa-user"></i>
                                                                <span class="detail-label">{{ trans('cancellations.student') }}:</span>
                                                                <span class="detail-value">{{ $cancellation->appointment->student->name }}</span>
                                                            </div>
                                                        @endif

    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form action="{{ route('admin.services.store') }}" method="post" id="store_form"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <textarea name="description[en]" id="description_en" class="form-control mb-2 summernote" rows="4" required>{{ old('description.en') }}</textarea>
                                                ...
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <textarea name="description[ar]" id="description_ar" class="form-control mb-2 summernote" rows="4" required>{{ old('description.ar') }}</textarea>
                                            ...
                                            <div class="d-flex flex-wrap gap-5 mb-3 mt-3">
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <input type="text" name="meta_title[en]" id="meta_title_en"
                                                        class="form-control mb-2" value="{{ old('meta_title.en') }}" required />
                                                    @error('meta_title.en')
                                                        <span class="invalid-feedback d-block"
                                                            role="alert">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <input type="text" name="meta_title[ar]" id="meta_title_ar"
                                                        class="form-control mb-2" value="{{ old('meta_title.ar') }}" required />
                                                    @error('meta_title.ar')
                                                        <span class="invalid-feedback d-block"
                                                            role="alert">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <textarea name="meta_description[en]" id="meta_description_en" class="form-control mb-2 summernote" rows="4" required>{{ old('meta_description.en') }}</textarea>
                                                ...
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <textarea name="meta_description[ar]" id="meta_description_ar" class="form-control mb-2 summernote" rows="4" required>{{ old('meta_description.ar') }}</textarea>

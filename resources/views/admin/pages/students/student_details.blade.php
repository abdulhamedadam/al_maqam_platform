<div class="d-flex flex-wrap flex-sm-nowrap  mb-6">
    ...
    <div class="me-7 mb-4">
        <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
            ...
            @else
                <img src="{{ asset($all_data->gender === 'm' ? 'front_assets/images/sections/teachers/man-avatar.svg' : 'front_assets/images/sections/teachers/woman-avatar.svg') }}" alt="" />
            @endif
            <div
    ...
    <div class="flex-grow-1">
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
            ...
            <div class="d-flex my-4">
                <a href="{{ route('admin.students.index', ['status' => 1]) }}" class="btn btn-sm btn-light me-2"
                    id="kt_user_follow_button">
                    <i class="ki-duotone ki-check fs-3 d-none"></i>
                    <span class="indicator-label">{{ trans('students.back') }}</span>
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{ $courses_count }}">{{ $courses_count }}</div>
                        </div>
                        <div class="fw-semibold fs-6 text-gray-500">{{ trans('students.cources') }}</div>
                    </div>
                    ...
                    {{-- <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                        ...
                        <div class="fw-semibold fs-6 text-gray-500">{{ trans('students.students') }}</div>
                    </div> --}}
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                        ...
                        <div class="fw-semibold fs-6 text-gray-500">{{ trans('students.ratings') }}</div>
                    </div>

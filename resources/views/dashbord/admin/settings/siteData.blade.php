                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ route('admin.save_siteData') }}" enctype="multipart/form-data"
                                            ...
                                            <div class="row col-md-12" style="margin: 10px">
                                                ...
                                                {{-- <div class="col-md-6">
                                                    <label for="branch_id" class="form-label">{{ trans('settings.branch_id') }}</label>
                                                    <input type="branch_id" class="form-control" name="branch_id" id="branch_id" value="">
                                                    <select class="form-control" name="branch_id" id="branch_id">
                                                        <option value="">{{ trans('settings.select_branch') }}</option>
        ...
        var KTDatatablesServerSide = function() {
            var initFormData = function() {
                ...
                success: function(data) {
                    ...
                    // branchSelect.empty();
                    // branchSelect.append('<option value="">{{ trans('settings.select_branch') }}</option>');
                    ...
                    // $('#branch_id').val(allData.branch_id);
                    $('#fax').val(allData.fax);

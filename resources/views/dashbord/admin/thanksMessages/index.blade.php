...
@section('toolbar')
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        @php
        $title = trans('mobile.thanksMessages');
         $breadcrumbs = [
                  ['label' => trans('Toolbar.thanksMessages'), 'link' => ''],
                  ['label' => trans('mobile.thanksMessages_table'), 'link' => '']
                  ];
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table1').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "{{ route('admin.thanksMessages.index') }}",
                },
                "columns": [

...
@section('toolbar')
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        @php
        $title = trans('mobile.reports');
         $breadcrumbs = [
                  ['label' => trans('Toolbar.reports'), 'link' => ''],
                  ['label' => trans('mobile.reports_table'), 'link' => '']
                  ];
                ...
                <table class="table" id="table1">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Phone Color</th>
        ...
        $(document).ready(function() {
            ...
            table = $('#table1').DataTable({
                ...
                "columns": [
                    ...
                    { data: 'imei1', className: 'text-center' },
                    { data: 'imei2', className: 'text-center' },
                    { data: 'phone_name', className: 'text-center' },
                    { data: 'phone_color', className: 'text-center' },
                    { data: 'contact_number', className: 'text-center' },
                    { data: 'found', className: 'text-center' },

...
@section('css')
    <link rel="stylesheet" href="{{ asset('front_assets/css/inc/teacher.css') }}">
@endsection
...
@section('content')
                ...
                <div class="col-12">
                    <div class="card profile-card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="country">egypt</h4>
                            <p class="teacher-bio">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                Perferendis dolores nulla minus dolor accusantium quibusdam
                                itaque magnam quia explicabo? Quo.
                            </p>
                            <section class="numbers">
                                <span class="numbers-title">students number:</span>
                                <span class="numbers-students">200</span>
                                <span class="slash">/</span>
                                <span class="numbers-title">classes number:</span>
                                <span class="numbers-classes">100</span>
                            </section>
                            <section class="numbers">
                                <span class="numbers-title">Ratings rate:</span>
                                <span class="numbers-students">5<i class="fa-solid fa-star"
                                        style="color: #ffea00"></i></span>
                                <span class="slash">/</span>
                                <span class="numbers-title">ratings number:</span>
                                <span class="numbers-classes">5</span>
                            </section>
                            <section class="specialty">
                                <span class="specialty-title">languages:</span>
                                <span class="teacher-specialty tags tags-hover">arabic</span>
                            </section>
                            <section class="specialty">
                                <span class="specialty-title">teachs:</span>
                                <a href="/our-lectures.html" class="teacher-specialty tags tags-hover">holy Quraan</a>
                                <a href="/our-lectures.html" class="teacher-specialty tags tags-hover">arabic language</a>
                            </section>
                        </div>
                    </div>
                </div>
    ...
    <section class="teacher-lectures teacher-profile">
        <div class="container">
            <div class="row clearfix">
                <div class="col-12">
                    <div class="card lecture-text courses-card profile-card">
